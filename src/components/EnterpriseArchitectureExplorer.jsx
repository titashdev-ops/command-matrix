...
const NODE_DETAILS = {
  ...
  serverless: { title: "Serverless Functions", purpose: "Compute", resp: "On-demand execution", decision: "Edge functions ensure sub-50ms cold starts globally.", future: "Stateful edge computing patterns.", dependencies: ["api", "vercel"] },
  ...
  cicd: { title: "CI/CD", purpose: "Automation", resp: "Testing, linting, building", decision: "GitHub Actions ensures zero manual intervention between merge and production.", future: "Automated chaos engineering tests.", dependencies: ["github", "deployment"] },
  ...
  monitoring: { title: "Monitoring", purpose: "Observability", resp: "APM, uptime checks", decision: "Distributed tracing across the edge and database pinpoints bottlenecks in real time.", future: "Predictive anomaly detection.", dependencies: ["error", "logging"] },
